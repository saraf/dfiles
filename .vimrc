...
let g:DoxygenToolkit_authorName="Aalhad Saraf <aalhad@saraf.systems>"

" Underline the current line with dashes in insert mode
inoremap <F5> <Esc>yyp<c-v>$r-A
"automatically underline all characters in a line with dashes
...
cmap <Leader>w !echo scp %:p root@172.16.10.100:/tmp/path/%
